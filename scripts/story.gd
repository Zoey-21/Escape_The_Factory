...
func text():
	...
	tie.buff_silence(1)
	tie.buff_text("Humming, they kept an eye on to the finshed robots for physical problems\n", 0.1)
	tie.buff_text("But hidden on the other side of the convaribelt... \n", 0.1)
	tie.buff_text("A living slime was adding itself to the robots,\n", 0.1)
	tie.buff_text("And the robots came to life!\n", 0.1)
	tie.buff_silence(1)
	tie.buff_text("Seeing this Jim ran to the nearist portal and sounded the alarm for evacuation.", 0.1) 
