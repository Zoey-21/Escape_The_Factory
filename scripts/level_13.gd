...
func _ready():
	...
	spawn_list = [shooter_scene,shooter_scene,shooter_scene,shooter_scene,wait,
	
	floater_scene,floater_big_scene,floater_scene,wait,
	
	dog_walker_scene,dog_walker_scene,floater_big_scene,floater_big_scene,wait,
	
	floater_scene,floater_scene,floater_scene,floater_scene,floater_scene,floater_scene,wait,
	
	floater_big_scene,floater_big_scene,
