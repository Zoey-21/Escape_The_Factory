...
func _ready():
	...
	NEED_TO_KILL = 11# amount of kills needed to win level    dont count turrets   count floater_big_scene twice
	spawn_list = [dog_walker_scene,dog_walker_scene,shooter_scene,dog_walker_scene,
	
	floater_scene,floater_scene,floater_scene,floater_big_scene,
	
	shooter_scene,dog_walker_scene,dog_walker_scene,
